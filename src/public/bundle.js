...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(/*! /Users/malin/www/todo/src/app/index.jsx */1);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Todo = __webpack_require__(/*! ./components/Todo.jsx */ 160);
	
	var _Todo2 = _interopRequireDefault(_Todo);
	
	__webpack_require__(/*! ./styles/Todo.scss */ 166);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TodoForm = __webpack_require__(/*! ./TodoForm.jsx */ 161);
	
	var _TodoForm2 = _interopRequireDefault(_TodoForm);
	
	var _TodoList = __webpack_require__(/*! ./TodoList.jsx */ 162);
	
	var _TodoList2 = _interopRequireDefault(_TodoList);
	
	var _firebase = __webpack_require__(/*! firebase */ 165);
	...
	var dataUrl = 'https://fiery-inferno-3889.firebaseio.com/todos';
	...
	var Todo = function (_React$Component) {
	  ...
	  _createClass(Todo, [{
	    ...
	    value: function loadTodos() {
	      ...
	      var dataRef = new _firebase2.default(dataUrl);
	    ...
	    value: function deleteItem(id) {
	      ...
	      var dataRef = new _firebase2.default(dataUrl + id);
	      dataRef.remove();
	    }
	  }, {
	    key: 'checkItem',
	  ...
	  _createClass(TodoForm, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'form',
	          { ref: 'todoForm', id: 'todoForm', className: 'Todo-form', onSubmit: this.handleForm },
	          _react2.default.createElement(
	            'div',
	            { className: 'Todo-formItem' },
	            _react2.default.createElement('input', { className: 'Todo-input', ref: 'text', type: 'text', placeholder: 'Title' }),
	            _react2.default.createElement(
	              'button',
	              { type: 'submit', className: 'Todo-button' },
	              _react2.default.createElement('i', { className: 'Todo-icon Todo-icon--add' }),
	              'Add'
	            )
	          )
	        )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TodoItem = __webpack_require__(/*! ./TodoItem.jsx */ 163);
	  ...
	  _createClass(TodoList, [{
	    ...
	    value: function render() {
	      ...
	      var listItems = this.props.items.map(function (item) {
	        return _react2.default.createElement(_TodoItem2.default, { key: item.key,
	          id: item.key,
	          text: item.text,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactContenteditable = __webpack_require__(/*! react-contenteditable */ 164);
	...
	var TodoItem = function (_React$Component) {
	  ...
	  _createClass(TodoItem, [{
	    ...
	    value: function checkItem() {
	      var val = this.props.checked ? 0 : 1;
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'li',
	        { key: this.props.key, className: itemClasses },
	        _react2.default.createElement(
	          'button',
	          { id: 'check', className: 'Todo-button Todo-button--check',
	        ...
	        _react2.default.createElement(
	          'button',
	          { id: 'delete', className: 'Todo-button Todo-button--delete',
	            onClick: this.deleteItem },
	          _react2.default.createElement('i', { className: 'Todo-icon Todo-icon--delete' }),
	          'Delete'
	        )
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	// load the styles
	var content = __webpack_require__(/*! !./../../../~/css-loader!./../../../~/sass-loader!./Todo.scss */ 167);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".Todo {\n  width: 90%;\n  background: #ddd;\n  color: #222;\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n  font-family: 'Open Sans', sans-serif;\n  border-radius: 5px; }\n  @media (min-width: 640px) {\n    .Todo {\n      width: 600px; } }\n  .Todo h2 {\n    text-align: center; }\n\n.Todo-inner {\n  margin: 20px; }\n  @media (min-width: 640px) {\n    .Todo-inner {\n      margin: 40px; } }\n\n.Todo-formItem {\n  position: relative; }\n\n.Todo-input {\n  padding: 20px 50px 20px 20px;\n  border: none;\n  width: 100%;\n  border-radius: 5px;\n  font-size: 1em;\n  line-height: 1.6;\n  margin: 10px 0; }\n\n.Todo-list {\n  padding: 0;\n  list-style: none; }\n\n.Todo-item {\n  padding: 20px 105px 20px 60px;\n  background: white;\n  margin: 10px 0;\n  border-radius: 5px;\n  position: relative; }\n\n.Todo-item--checked {\n  background: rgba(255, 255, 255, 0.5); }\n\n.Todo-text {\n  line-height: 1.6;\n  font-size: 1em;\n  width: 100%;\n  border: none;\n  background: none;\n  resize: none; }\n  .Todo-item--checked .Todo-text {\n    color: #999;\n    font-style: italic;\n    text-decoration: line-through; }\n\n.Todo-button {\n  color: white;\n  height: 40px;\n  width: 40px;\n  border-radius: 50%;\n  border: none;\n  background: #3BB1D9;\n  position: absolute;\n  right: 10px;\n  top: 50%;\n  transform: translateY(-50%);\n  font-size: 0;\n  cursor: pointer; }\n  .Todo-button:hover {\n    background: #2596bc; }\n  .Todo-button:focus {\n    outline: none; }\n\n.Todo-button--check {\n  left: 10px;\n  right: auto;\n  background: #DDD; }\n  .Todo-button--check:hover {\n    background: #3ABDAF; }\n  .Todo-item--checked .Todo-button--check {\n    background: #3ABDAF; }\n\n.Todo-button--delete {\n  background: #ED5465; }\n  .Todo-button--delete:hover {\n    background: #e8263b; }\n\n.Todo-button--edit {\n  right: 55px;\n  background: #B377D8; }\n  .Todo-button--edit:hover {\n    background: #9d4fcd; }\n  .Todo-item--checked .Todo-button--edit {\n    display: none; }\n\n.Todo-button--update {\n  right: 55px; }\n\n.Todo-icon {\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n  width: 24px;\n  height: 24px; }\n\n.Todo-icon--add {\n  background-image: url(" + __webpack_require__(/*! ../images/add.svg */ 169) + ");\n  background-size: cover; }\n\n.Todo-icon--check {\n  background-image: url(" + __webpack_require__(/*! ../images/check.svg */ 170) + ");\n  background-size: cover; }\n\n.Todo-icon--edit {\n  background-image: url(" + __webpack_require__(/*! ../images/edit.svg */ 171) + ");\n  background-size: cover; }\n\n.Todo-icon--delete {\n  background-image: url(" + __webpack_require__(/*! ../images/remove.svg */ 172) + ");\n  background-size: cover; }\n\n.Todo-icon--update {\n  background-image: url(" + __webpack_require__(/*! ../images/save.svg */ 173) + ");\n  background-size: cover; }\n", ""]);
...
/* 169 */
/*!********************************!*\
  !*** ./src/app/images/add.svg ***!
  \********************************/
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "img/img-fab9f2.svg";

/***/ },
/* 170 */
/*!**********************************!*\
  !*** ./src/app/images/check.svg ***!
  \**********************************/
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "img/img-d19856.svg";

/***/ },
/* 171 */
/*!*********************************!*\
  !*** ./src/app/images/edit.svg ***!
  \*********************************/
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "img/img-2263db.svg";

/***/ },
/* 172 */
/*!***********************************!*\
  !*** ./src/app/images/remove.svg ***!
  \***********************************/
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "img/img-ad4b93.svg";
